      ...
      <div className="border rounded-3 border-success p-3 shadow">
        ...
        <Form className="d-flex flex-column">
          <Form.Group className="mb-3">
            ...
            <Form.Group>
              <Form.Label>
                Select meal plans based on dietary preferences
              </Form.Label>
              <Form.Select
            ...
            <Form.Group>
              <Form.Label>Recipes Name</Form.Label>
            ...
            <Form.Group>
              <Form.Label>Write the nutritional information</Form.Label>
              <Form.Control
                as="textarea"
                row={4}
              ...
              <Form.Label>Ingredients Information</Form.Label>
              <InputGroup>
                <Form.Control
                  as="textarea"
                  row={4}
              ...
              <span>Characters: {cookContentCount}/700</span>
            </Form.Group>
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Prepared Meals Image </Form.Label>
            <Form.Control
              type="file"
              accept=".jpg, .jpeg, .png"
